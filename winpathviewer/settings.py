# Django settings for winpathviewer project.
import commands
import os
import sys
...
ROOT_URLCONF = 'winpathviewer.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'winpathviewer.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('winpathviewer.migrations', 'winpathviewer.tests',
                            'winpathviewer.local_settings',
...
#GLOSSOLALIA_NAME = 'winpathviewer'

# OPAL required Django settings you should edit

CONTACT_EMAIL = []
DEFAULT_FROM_EMAIL = 'hello@example.com'
DEFAULT_DOMAIN = 'http://winpathviewer.com/'

# Begins OPAL Settings you should edit !

OPAL_BRAND_NAME = 'winpathviewer'
